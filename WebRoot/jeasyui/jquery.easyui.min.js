 ...
 * 
 * zhouw  
 * line:2759   	style=\"color:#fff;margin:0 10px;\"
 * line:6614	$(this).tooltip("tip").css({height:"25px",lineHeight:"25px",color:"rgb(255,255,255)",borderColor:"rgb(102,153,204)",backgroundColor:"rgba(51, 153, 204, 0.8)"});
 * 
 */
(function($){
...
var tip=_1fb.tip;
if(!tip){
tip=$("<div tabindex=\"-1\" class=\"tooltip\">"+"<div class=\"tooltip-content\" style=\"color:#fff;margin:0 10px;\"></div>"+"<div class=\"tooltip-arrow-outer\"></div>"+"<div class=\"tooltip-arrow\"></div>"+"</div>").appendTo("body");
_1fb.tip=tip;
_1fc(_1fa);
}
_1f1(_1fa);
...
$(this).tooltip("tip").css({height:"25px",lineHeight:"25px",color:"rgb(255,255,255)",borderColor:"rgb(102,153,204)",backgroundColor:"rgba(51, 153, 204, 0.8)"});
},onHide:function(){
$(this).tooltip("destroy");
